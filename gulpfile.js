...
var npmEntry ='./built/app/bundle.js';
...
gulp.task('build-lib-sourcemap', ['jsrsasign'], function() {
  // run webpack
  return gulp.src('./built/app/bundle.js').pipe(webpackStream(createWebpackConfig({
    mode: 'development',
    entry: npmEntry,
    output: {
        filename:'wso2is-client.js',
        libraryTarget:'umd'
    },
    plugins: [
